...
// Pin commands 080 - 084 ESP32sensorsI2C
const uint8_t ESP32sensorsCmdOffset  = 80;
...
/*!
  ...
  a slave running the appropriate @ref firmware.ino firmware, given that ESP32
...
public:
   ...
   * @param pin Note, again, that if your master is not an ESP32, the pin names 
   * T0..T9 will not be known, so use their raw pin equivalents.
   */
  uint16_t touchRead(uint8_t pin);

  /*!
   * @brief Of course, you can't set your own callback funtion for the slave.
